	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '/static/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/static/progressbg_red.gif',
									30: '/static/progressbg_orange.gif',
									70: '/static/progressbg_green.gif'
								},
