...
$(function() {
        //check(true);
		previousCrc = crc32(document.documentElement.outerHTML);
        ...
        $.ajax({
                ...
                success: function(data) {                                               
                        ...
                        if(firstRun) {  
								...
								previousCrc = crc32(document.documentElement.outerHTML); //On charge le contenu du document au cas ou data serait deja different
                                return;
                        }
...
(function() { 
    ...
    crc32 = function( /* String */ str, /* Number */ crc ) { 
		...
		if (code != 10 && code != 32) { //On ne considere pas les espacement et retours a la ligne
            n = ( crc ^ code ) & 0xFF; 
