...
urlpatterns = patterns('',
    ...
    (r'^associations/trium/informations/$',direct_to_template, {'template': 'trium/informations.html'}),
   # (r'^associations/jump/$', 'jump.views.etudes'),    
    ...
    (r'^people/separation/mine/$',direct_to_template, {'template': 'trombi/graphe-mine.html'}),
    ...
    (r'^entreprises/$','bde.views.presentation_entreprises'),
    (r'^entreprises/contact/$','bde.views.contact_entreprises'),
    (r'^chat/', include('chat.urls')),
    (r'^tinymce/', include('tinymce.urls')),
    (r'^buypacker/redimensionnement/', direct_to_template, {'template': 'buypacker/redimensionnement.html'}),
